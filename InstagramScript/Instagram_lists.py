...
class TaskOrderWindow(QDialog):
    ...
    def initUI(self):
        ...
        if self.config:
            ...
            show_labels[1] = self.config.get("Key_IsEnableKey", False)
            show_labels[2] = self.config.get("HuDong_IsHuDong", False)
