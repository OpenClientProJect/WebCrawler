...
class MyApplog(QDialog):
    ...
    def initUI(self):
        ...
        self.title_label.setStyleSheet("color: #f08763;font-weight: bold;")  # 设置标题颜色
        self.setFixedSize(350, 0)  # 设置窗口的固定大小
        title_bar.addWidget(self.title_label)
        title_bar.addStretch(1)
        ...
        username_label = QLabel("Theads賬號:")
        ...
        password_label = QLabel("Theads密碼:")
...
def win_main():
    ...
    app.setStyle('Fusion')
    palette = QPalette()
    palette.setColor(QPalette.Window, QColor(253, 245, 230))  # #f8f4ff
    palette.setColor(QPalette.WindowText, QColor(51, 51, 51))
    palette.setColor(QPalette.Base, QColor(255, 255, 255))
    palette.setColor(QPalette.AlternateBase, QColor(253, 245, 230))
    palette.setColor(QPalette.ToolTipBase, QColor(253, 245, 230))
    palette.setColor(QPalette.ToolTipText, QColor(51, 51, 51))
    palette.setColor(QPalette.Text, QColor(51, 51, 51))
    palette.setColor(QPalette.Button, QColor(253, 245, 230))
