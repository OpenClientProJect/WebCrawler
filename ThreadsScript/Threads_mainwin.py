...
class MyApp(QWidget):
    ...
    def initUI(self):
        ...
        self.setFixedSize(900, 480)  # 增加窗口宽度，右侧会更长
        ...
        # 左侧底部文本
        left_text = QLabel("Threads自動化管理平台\n高效安全的社交媒體管理解決方案")
        left_text.setAlignment(Qt.AlignCenter)
        left_text.setFont(QFont("微軟雅黑", 10))
        left_text.setStyleSheet("background-color: #fff9ec;color: #666; padding: 10px;")
        ...
        login_title0 = QLabel("Threads自動化腳本")
        ...
        login_title.setStyleSheet("margin-top: 10px; margin-bottom: 20px;color: #feaa71;font-weight: bold;")
